...
<head>
    ...
    <meta content="Sistem Registrasi Anggota Racana" name="description" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ URL::asset('build/img/logo/logo.jpg') }}">
    ...
    <style>
        ...
        .overlay {
            ...
            top: 0;
            left: 0;
            background: rgba(255, 255, 255, 0.8) url("<?php echo e(url('assets/img/loading.gif')); ?>") center no-repeat;
        }
